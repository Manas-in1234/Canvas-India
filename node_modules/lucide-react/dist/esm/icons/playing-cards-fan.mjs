...
const __iconNode = [
  ...
  ["path", { d: "M18 7.777V4a2 2 0 00-2-2h-6a2 2 0 00-2 2v10a2 2 0 001.137 1.805", key: "y6hc3m" }],
  [
    "path",
    {
...
const PlayingCardsFan = createLucideIcon("playing-cards-fan", __iconNode);

export { __iconNode, PlayingCardsFan as default };
