...
export const ALL_PRODUCTS: Product[] = [
  ...
  // ==========================================
  // 2. ACRYLIC CATEGORY (8 Demo Products)
  // ==========================================
  {
    id: 'acr-1',
    name: 'Premium Acrylic Photo Panel',
    slug: 'premium-acrylic-photo-panel',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Acrylic Photo Panels',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Direct UV print behind 5mm optical cast acrylic glass with polished edges and stainless steel mounting studs.',
    shortDescription: 'Glossy 5mm acrylic photo panel with floating wall studs.',
    material: '5mm Optical Grade Cast Acrylic Glass',
    sizes: ['12x12 inch', '12x18 inch', '18x24 inch', '24x36 inch'],
    finishes: ['High Gloss Clear', 'Anti-Glare Frosted', 'Solid White Backing'],
    customizationAvailable: true,
    uploadRequired: true,
    tags: ['acrylic', 'photo', 'wall art', 'modern'],
    stockStatus: 'In Stock',
    applications: ['Modern Living Room', 'Bedroom', 'Office Corridor'],
    isDemoData: true
  },
  {
    id: 'acr-2',
    name: 'Modern Abstract Acrylic Art',
    slug: 'modern-abstract-acrylic-art',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Acrylic Wall Art',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Fluid marble and vibrant contemporary art encapsulated within crystal-grade acrylic for maximum light refraction.',
    shortDescription: 'Dynamic contemporary abstract art behind ultra-clear acrylic.',
    ...
    customizationAvailable: true,
    tags: ['acrylic', 'abstract', 'wall art', 'decor'],
    stockStatus: 'In Stock',
    applications: ['Living Room', 'Hotel Lobby', 'Modern Penthouse'],
    isDemoData: true
  },
  {
    id: 'acr-3',
    name: 'Family Acrylic Print',
    slug: 'family-acrylic-print',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Acrylic Photo Panels',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Transform special family portraits into frameless glass-look displays with depth and high color fidelity.',
    ...
    customizationAvailable: true,
    uploadRequired: true,
    tags: ['family', 'acrylic', 'photo', 'portrait'],
    stockStatus: 'In Stock',
    applications: ['Family Lounge', 'Master Suite', 'Dining Wall'],
    isDemoData: true
  },
  {
    id: 'acr-4',
    name: 'Corporate Acrylic Wall Panel',
    slug: 'corporate-acrylic-wall-panel',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Corporate Acrylic',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Professional company values, mission statements, and office graphics on sleek optical acrylic.',
    shortDescription: 'Enterprise architectural acrylic wall panel for workplaces.',
    material: '6mm Cast Monomer Acrylic & Chrome Standoffs',
    sizes: ['18x24 inch', '24x36 inch', '30x48 inch'],
    finishes: ['Crystal Clear', 'Frosted Backing'],
    customizationAvailable: true,
    tags: ['corporate', 'acrylic', 'office', 'signage'],
    stockStatus: 'In Stock',
    applications: ['Executive Boardroom', 'Reception Wall', 'Hallways'],
    isDemoData: true
  },
  {
    id: 'acr-5',
    name: 'Reception Acrylic Artwork',
    slug: 'reception-acrylic-artwork',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'High impact architectural acrylic panel customized with your company identity or statement visual art.',
    shortDescription: 'Grand acrylic showcase panel for reception entrance areas.',
    material: '8mm Ultra-Clear Architectural Acrylic',
    sizes: ['24x36 inch', '30x48 inch', 'Set of 3 Multi-Panel'],
    finishes: ['Diamond Polished Edge with LED Backlight Ready'],
    customizationAvailable: true,
    tags: ['reception', 'acrylic', 'corporate', 'signage'],
    stockStatus: 'In Stock',
    applications: ['Reception Foyer', 'Showrooms', 'Hotel Concierge'],
    isDemoData: true
  },
  {
    id: 'acr-6',
    name: 'Inspirational Acrylic Quote',
    slug: 'inspirational-acrylic-quote',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Inspirational Acrylic',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Sleek typography printed behind crystal glass, ideal for modern desks and minimalist interior themes.',
    shortDescription: 'Minimalist quote behind glossy optical acrylic.',
    material: '4mm Cast Acrylic',
    sizes: ['8x10 inch', '12x12 inch', '12x18 inch'],
    finishes: ['Gloss Clear', 'Freestanding Desk Block (20mm)'],
    customizationAvailable: true,
    tags: ['inspirational', 'acrylic', 'quote', 'desk'],
    stockStatus: 'In Stock',
    applications: ['Workstation Desk', 'Study', 'Wall Mount'],
    isDemoData: true
  },
  {
    id: 'acr-7',
    name: 'Premium Decorative Acrylic Panel',
    slug: 'premium-decorative-acrylic-panel',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Decorative Acrylic Panels',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Luminous graphic artwork with 3D depth, designed to catch natural ambient room light.',
    ...
    customizationAvailable: true,
    tags: ['decor', 'acrylic', 'panel', 'wall art'],
    stockStatus: 'In Stock',
    applications: ['Living Room Feature Wall', 'Dining Wall', 'Hospitality'],
    isDemoData: true
  },
  {
    id: 'acr-8',
    name: 'Personalized Acrylic Gift',
    slug: 'personalized-acrylic-gift',
    category: 'Acrylic',
    categorySlug: 'acrylic',
    subcategory: 'Customized Acrylic Gifts',
    ...
    reviewsCount: 0,
    badge: 'New',
    description: 'Heavy freestanding diamond-cut acrylic block featuring your custom photo and heartfelt message.',
    shortDescription: '20mm freestanding crystal acrylic photo keepsake block.',
    material: '20mm Solid Cast Acrylic Block',
    sizes: ['4x6 inch', '5x7 inch', '6x8 inch'],
    finishes: ['Freestanding Desk Block', 'Beveled Edges'],
    customizationAvailable: true,
    uploadRequired: true,
    tags: ['gift', 'acrylic', 'personalized', 'anniversary'],
    stockStatus: 'In Stock',
    applications: ['Desk Display', 'Bedside Table', 'Gift Boxed'],
    isDemoData: true
  },
