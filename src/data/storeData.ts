...
export const CANVAS_FILTER_OCCASIONS = [
  'Birthday',
  'Anniversary',
  'Wedding',
  'Housewarming',
...
export const CANVAS_PRODUCTS: Product[] = [
  {
    id: 'prod-1',
    name: 'Custom Canvas Print',
    category: 'Canvas Prints',
    ...
    sizes: ['8x10 inch', '12x18 inch', '16x24 inch', '24x36 inch'],
    finishes: ['Matte Canvas', 'Satin Finish', 'Floating Frame'],
    occasions: ['Birthday', 'Anniversary', 'Housewarming', 'Corporate Gifts'],
  },
  {
    id: 'deal-1',
    name: 'Mini Canvas Desk Print',
    ...
    sizes: ['6x6 inch', '8x8 inch'],
    finishes: ['Matte Canvas with Easel'],
    occasions: ['Birthday', 'Corporate Gifts', 'Diwali'],
  },
  {
    id: 'prod-7',
    name: 'Custom Quote Canvas',
    ...
    sizes: ['12x18 inch', '16x24 inch', '20x30 inch'],
    finishes: ['Clean Minimalist', 'Vintage Textured', 'Bold Typography'],
    occasions: ['Birthday', 'Housewarming', 'Corporate Gifts'],
  },
  {
    id: 'prod-4',
    name: 'Family Photo Canvas',
    ...
    sizes: ['16x20 inch', '20x30 inch', '24x36 inch'],
    finishes: ['Mirrored Edge', 'Solid Black Edge', 'Folded Edge'],
    occasions: ['Anniversary', 'Wedding', 'Diwali', 'Housewarming'],
  },
  {
    id: 'canvas-wedding-panoramic',
    name: 'Grand Panoramic Wedding Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=600&auto=format&fit=crop&q=80',
    rating: 4.9,
    ...
    discountPercent: 24,
    badge: 'Popular',
    description: 'Wide panoramic wedding ceremony memories printed on fine archival cotton weave.',
    sizes: ['12x36 inch', '16x48 inch', '20x60 inch'],
    finishes: ['Museum Gallery Wrap', 'Teak Floater Frame', 'Gold Accent Frame'],
    occasions: ['Wedding', 'Anniversary'],
  },
  {
    id: 'canvas-living-room-set',
    name: 'Living Room Gallery Canvas Set (3 Panels)',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&auto=format&fit=crop&q=80',
    rating: 4.8,
    ...
    discountPercent: 28,
    badge: 'Best Seller',
    description: 'Triptych 3-panel split wall art set for modern living rooms and master bedrooms.',
    sizes: ['Set of 3 (12x18 each)', 'Set of 3 (16x24 each)'],
    finishes: ['Matched Gallery Wrap', 'Slim Black Floater Frame'],
    occasions: ['Housewarming', 'Diwali', 'Anniversary'],
  },
  {
    id: 'canvas-diwali-pooja',
    name: 'Festive Diwali Pooja Wall Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    ...
    discountPercent: 33,
    badge: 'Sale',
    description: 'Sacred motifs, mandalas, and festive spiritual artwork on textured cotton canvas.',
    sizes: ['12x12 inch', '16x16 inch', '20x20 inch'],
    finishes: ['Warm Gold Border', 'Archival Matte Wrap'],
    occasions: ['Diwali', 'Housewarming'],
  },
  {
    id: 'canvas-corporate-vision',
    name: 'Corporate Vision & Values Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=600&auto=format&fit=crop&q=80',
    rating: 4.9,
    ...
    discountPercent: 24,
    badge: 'Trending',
    description: 'Executive conference room and office mission statement canvas prints with corporate finish.',
    sizes: ['24x36 inch', '30x45 inch', '36x48 inch'],
    finishes: ['Gallery Wrap', 'Matte Charcoal Floater Frame'],
    occasions: ['Corporate Gifts'],
  },
  {
    id: 'canvas-couple-memory',
    name: 'Romantic Couple Photo Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    ...
    discountPercent: 25,
    badge: 'Hot',
    description: 'Cherished memories and anniversary dates designed with elegant vintage filters.',
    sizes: ['12x18 inch', '16x24 inch', '20x30 inch'],
    finishes: ['Satin Protective Glaze', 'Natural Teak Frame'],
    occasions: ['Anniversary', 'Wedding', 'Birthday'],
  },
  {
    id: 'canvas-split-panel',
    name: '5-Panel Panoramic Landscape Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1577083552431-6e5fd01aa342?w=600&auto=format&fit=crop&q=80',
    rating: 4.8,
    ...
    discountPercent: 25,
    badge: 'Popular',
    description: 'Dramatic multi-tier 5-piece split canvas centerpiece for spacious living and dining halls.',
    sizes: ['5-Piece Total (60x32 inch)', '5-Piece Total (72x40 inch)'],
    finishes: ['Mirrored Continuous Wrap', 'Matte Fine Art'],
    occasions: ['Housewarming', 'Anniversary'],
  },
  {
    id: 'canvas-kids-milestone',
    name: 'Kids Milestone Birthday Canvas',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=600&auto=format&fit=crop&q=80',
    rating: 4.7,
    ...
    discountPercent: 25,
    badge: 'New',
    description: 'First year baby milestones, growth stats, and joyful birthday moments.',
    sizes: ['12x16 inch', '16x20 inch'],
    finishes: ['Vivid Child-Safe Inks', 'Soft Rounded Wrap'],
    occasions: ['Birthday'],
  },
  {
    id: 'canvas-executive-desk',
    name: 'Executive Square Canvas Block',
    category: 'Canvas Prints',
    categorySlug: 'canvas',
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&auto=format&fit=crop&q=80',
    rating: 4.8,
    ...
    discountPercent: 33,
    badge: 'Best Seller',
    description: 'Freestanding 1.5-inch deep solid pine canvas block for office desks and console tables.',
    sizes: ['8x8 inch', '10x10 inch'],
    finishes: ['Deep Gallery Stand', 'Solid Wood Frame'],
    occasions: ['Corporate Gifts', 'Birthday'],
  },
];
